...
import { /* IBlogFile, */ IDocFile, versions } from '../lib/types'
...
const contentDir = (version: versions) =>
  path.join(__dirname, `../temp/i18n-${version}/content`)
...
async function main() {
  ...
  //   acc[locale] = require(`../temp/i18n-current/content/${locale}/website/locale.yml`)
  //   return acc
