...
const MERGEABILITY_RETRY_WAIT_TIME = 5000
var Mergeability
;(function(Mergeability) {
  Mergeability[(Mergeability['MERGEABLE'] = 0)] = 'MERGEABLE'
  Mergeability[(Mergeability['UNMERGEABLE'] = 1)] = 'UNMERGEABLE'
  Mergeability[(Mergeability['UNKNOWN'] = 2)] = 'UNKNOWN'
 ...
 *           in autoMerger() function.
 */
const getMergeability = async pr => {
 ...
 *           in autoMerger() function.
 */
const mergeAndDeleteBranch = async pr => {
