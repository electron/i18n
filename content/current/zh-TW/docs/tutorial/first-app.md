...
你可以複製 [`electron/electron-quick-start`](https://github.com/electron/electron-quick-start) 儲存庫內檔案並執行此頁所示範例。
...
有關可用作開發程式的模版及工具列表，請參閱[模版及命令列介面 (CLI)](./boilerplates-and-clis.md)
