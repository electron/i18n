...
These new features bring those auditing tools to your Electron app. Ces nouvelles fonctionnalités apportent ces outils d'audit à votre application Electron. Lisez ci-dessous pour un résumé des outils ou consultez notre [documentation d'accessibilité](https://electronjs.org/docs/tutorial/accessibility/) pour plus d'informations.
