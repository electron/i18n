...
* [دامنه متغیر](https://msdn.microsoft.com/library/bzt2dkta(v=vs.94).aspx)
...
If [sub-pixel anti-aliasing](https://alienryderflex.com/sub_pixel/) is deactivated, then fonts on LCD screens can look blurry. مثال:
