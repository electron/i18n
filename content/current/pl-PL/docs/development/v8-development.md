...
> Kolekcja zasobów do nauki i używania V8

* [V8 Tracing](https://github.com/v8/v8/wiki/Tracing-V8)
* [V8 Profiler](https://github.com/v8/v8/wiki/V8-Profiler) - Kombinacje profilera, które są przydatne do profilowania: `--prof`, `--trace-ic`, `--trace-opt`, `--trace-deopt`, `--print-bytecode`, `--print-opt-code`
...
* [V8 Debugowanie GDB](https://github.com/v8/v8/wiki/GDB-JIT-Interface)
