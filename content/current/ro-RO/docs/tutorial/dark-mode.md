...
În MacOS 10.14 Mojave, Appled a introdus un nou [mod întunecat la nivel de sistem][system-wide-dark-mode] pentru toate computerele MacOS. If your Electron app has a dark mode, you can make it follow the system-wide dark mode setting using [the `nativeTheme` api](../api/native-theme.md).
