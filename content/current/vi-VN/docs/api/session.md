...
* `options` Object
  ...
  * `numSockets` Number (optional) - number of sockets to preconnect. Must be between 1 and 6. Mặc định là 1.
...
* `handler` Function | null
  ...
  * `permission` String - The type of requested permission.
    * `clipboard-read` - Yêu cầu quyền truy cập để đọc từ clipboard.
