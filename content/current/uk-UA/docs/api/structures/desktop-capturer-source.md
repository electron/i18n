...
* `appIcon` [NativeImage](../native-image.md) - Піктограма застосунку, який має вікно або null, якщо джерело має тип екран. The size of the icon is not known in advance and depends on what the application provides.
