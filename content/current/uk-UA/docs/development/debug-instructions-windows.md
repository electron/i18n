...
* **ProcMon**: [безкоштовний інструмент SysInternals](https://technet.microsoft.com/en-us/sysinternals/processmonitor.aspx), що дозволяє вам переглядати параметри процесів, дескриптори файлів та операції над реєстром.
