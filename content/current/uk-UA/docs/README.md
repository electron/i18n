...
* [Створення вашого першого застосунку](tutorial/quick-start.md)
...
* [Архітектура Застосунків](tutorial/quick-start.md#application-architecture)
  * [Головний та Процес Рендерингу](tutorial/quick-start.md#main-and-renderer-processes)
