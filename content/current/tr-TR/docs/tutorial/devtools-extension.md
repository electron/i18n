...
<li>Pass the location of the extension to the <a href="../api/session.md#sesloadextensionpath"><code>ses.loadExtension`</a> API. For React Developer Tools `v4.9.0`, it looks something like:
   ```javascript
