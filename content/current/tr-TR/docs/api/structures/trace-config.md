...
* `enable_argument_filter` boolean (opsiyonel) - eğer *true* ise herhangi bir PII içermemesi için manuel olarak incelenen belirli bir olaylar listesine göre olay verilerini filtreler. See [the implementation in Chromium](https://chromium.googlesource.com/chromium/src/+/master/services/tracing/public/cpp/trace_event_args_whitelist.cc) for specifics.
