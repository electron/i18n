...
Para formatar automaticamente um arquivo do Electron com o estilo do código C++, use `clang-format -i path/to/electron/file.cc`. Ele deve funcionar no macOS/Linux/Windows.
