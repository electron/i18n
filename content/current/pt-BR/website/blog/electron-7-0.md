...
Electron 7.0.0 foi lançado! Inclui upgrades para Chromium 78, V8 7.8 e Node.js 12.8.1. Adicionamos uma versão window on Arm 64, métodos IPC mais rápidos, uma nova API `nativeTheme` e muito mais!
