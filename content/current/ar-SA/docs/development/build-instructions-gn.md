...
gclient sync -f --with_branch_heads --with_tags
  ...
  --enable-logging -g 'BrowserWindow module'
    ...
    <p>
      If <code>gclient sync</code> is interrupted while using the git cache, it will leave the cache locked. لإزالة القفل، مرر <code>--ignore_locks</code> معطى إلى <code>gclient sync</code>.
    </p>
