...
Il team di Electron mantiene [update.electronjs.org](https://github.com/electron/update.electronjs.org), un servizio web gratuito e open-source che le app Electron possono utilizzare per l'auto-aggiornamento. Il servizio è progettato per le applicazioni Electron che soddisfano i seguenti criteri:
...
Se hai bisogno di personalizzare la configurazione, puoi [passare le opzioni a `update-electron-app`](https://github.com/electron/update-electron-app) o [utilizzare direttamente il servizio di aggiornamento](https://github.com/electron/update.electronjs.org).
...
autoUpdater.on('update-downloaded', (event, releaseNotes, releaseName) => {
  const dialogOpts = {
    ...
    dettaglio: 'Una nuova versione è stata scaricata. Riavvia l'applicazione per applicare gli aggiornamenti.'
  }
