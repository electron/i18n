...
Iniziando con macOS Catalina, Apple richiede che le applicazioni siano notarizzate. "Notarization" as defined by Apple means that you upload your previously signed application to Apple for additional verification _before_ distributing the app to your users.
