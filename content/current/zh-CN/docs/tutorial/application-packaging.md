...
大部分用户可以毫不费力地使用这个功能，因为它[`electron-packager`](https://github.com/electron/electron-packager),、[`electron-forge`](https://github.com/electron-userland/electron-forge)和[`electron-builder`](https://github.com/electron-userland/electron-builder)中都得到了支持，开箱即用。 如果你没有使用这些工具中的任何一个，那么请继续阅读。
