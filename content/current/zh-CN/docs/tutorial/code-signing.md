...
2. 下载并安装 [Xcode](https://developer.apple.com/xcode) - 这需要运行macOS 的计算机。
...
如果您打算使用Electron的API访问您的应用内的麦克风或摄像头，您还需要 添加以下权限：
...
您的应用可能会崩溃。 在 [艰苦运行时间](https://developer.apple.com/documentation/security/hardened_runtime) 中查看资源访问部分以获取更多信息和您可能需要的权限。
