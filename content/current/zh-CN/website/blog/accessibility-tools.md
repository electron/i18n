...
These new features bring those auditing tools to your Electron app. 您可以选择使用 Spectron 将审核添加到您的测试中，或在 DevTools 中与 Devtron 一起使用它们。 阅读工具摘要或结算我们的 [辅助文档](https://electronjs.org/docs/tutorial/accessibility/) 以获取更多信息。
