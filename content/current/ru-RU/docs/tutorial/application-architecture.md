...
Подавляющее большинство модулей Node.js *не являются* нативными. Только 400 из примерно 650,000 модулей являются таковыми. Однако, если вам всё же требуются нативные модули, обратитесь к [документации, как скомпилировать их для использования в Electron](./using-native-node-modules.md).