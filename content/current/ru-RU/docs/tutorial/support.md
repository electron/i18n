...
[До релиза Electron 2.0](../breaking-changes.md#duplicate-arm-assets), Electron также будет продолжать выпуск бинаркой сборки `armv7l` с простым `arm` суффиксом. Оба бинарных файла идентичны.
