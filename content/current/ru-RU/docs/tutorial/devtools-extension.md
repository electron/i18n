...
<li><p spaces-before="0">Find out the filesystem location used by Chrome for storing extensions:</p>
...
1 Pass the location of the extension to the [`ses.loadExtension`](../api/session.md#sesloadextensionpath-options) API. For React Developer Tools `v4.9.0`, it looks something like:
