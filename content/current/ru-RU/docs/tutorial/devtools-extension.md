...
1 Передайте местоположение расширения в [`ses.loadExtension`](../api/session.md#sesloadextensionpath-options) API. For React Developer Tools `v4.9.0`, it looks something like:
