...
* `options` Object (optional)
  ...
  * `darkTheme` Boolean (optional) - Forces using dark theme for the window, only works on some GTK desktop environments. Domyślnie jest `false`.
  ...
  * `webPreferences` Object (optional) - Settings of web page's features.
    ...
    * `enableRemoteModule` Boolean (optional) - Whether to enable the [`remote`](remote.md) module. Domyślnie jest `true`.
...
#### `win.setTouchBar(touchBar)` _macOS_ _Eksperymentalne_
