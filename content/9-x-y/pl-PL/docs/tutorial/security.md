...
Izolacja kontekstowa pozwala każdemu ze skryptów działających w renderowatorze na dokonywanie zmian w jego środowisku JavaScript bez obaw o konflikt z skryptami w API Electron lub skrypcie wstępnego wczytywania.
