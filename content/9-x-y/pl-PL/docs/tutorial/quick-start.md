...
* Aby sprawdzić, jak zbudowana jest prosta aplikacja, stworzona przy użyciu Electrona, zobacz [Pisanie Swojej Pierwszej Aplikacji][first-app]
* Aby sprawdzić, architekturę procesu, zobacz [Proces główny i renderer][processes].

Jeżeli chcesz dowiedzieć się więcej na temat Electron, przeczytaj [oficjalną dokumentacje][readme].
