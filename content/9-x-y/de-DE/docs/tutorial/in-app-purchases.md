...
inAppPurchase.on('transactions-updated', (event, transactions) => {
  ...
  transactions.forEach(function (transaction) {
    let payment = transaction. ayment
    ...
    wechseln (Transaktion. ransactionState) {
      ...
      Kasse 'gekauft':
        ...
        Konsole. og(`${payment.productIdentifier} gekauft.`)
        ...
        // Sende die Quittungsdatei an den Server und überprüfe, ob sie gültig ist.
      ...
      case 'failed':
        ...
        console.log(`Error to purchase ${payment.productIdentifier}.`)
