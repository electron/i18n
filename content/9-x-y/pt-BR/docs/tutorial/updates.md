...
O time do GitHub do Electron mantém o [update.electronjs.org][], um webservice grátis e open-source que os apps Electron podem usar para auto atualizar. The service is designed for Electron apps that meet the following criteria:
