...
* `cwd` String (optional) - The working directory. O padrão está vazio.
* `args` String (optional) - The arguments to be applied to `target` when launching from this shortcut. O padrão está vazio.
