...
* Чтобы узнать, как сделать простое приложение при помощи Electron, смотри: [Пишем свое первое приложение на Electron][first-app]
* Чтобы проверить архитектуру процесса, смотри [Основные и Визуализирующие процессы][processes].

Чтобы узнать больше об Electron, смотрите [официальное руководство][readme].
