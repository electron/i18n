...
* `enable_argument_filter` boolean (optional) - true 인 경우, PII를 포함하지 않도록 수동으로 조사된 이벤트의 화이트리스트에 따라 이벤트 데이터를 필터링합니다. 자세한 내용은 [the implementation in Chromium][trace_event_args_whitelist.cc]을 보세요.
