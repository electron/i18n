...
يمكنك جعل مجموعة الاختبار تعمل بشكل أسرع من خلال عزل الاختبار أو الكتلة المحددة تعمل حاليًا على استخدام الاختبارات الحصرية [](https://mochajs.org/#exclusive-tests) الميزة. Append `.only` to any `describe` or `it` function call:
