...
Il repository di Electron dipende anche da software di terze parti, che è possibile trovare nella cartella [/vendor][vendor]. In alcuni casi potreste vedere un messaggio come questo in risposta all'esecuzione di `git status`:
