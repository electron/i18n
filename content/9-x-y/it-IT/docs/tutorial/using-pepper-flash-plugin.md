...
Su macOS e Linux, i dettagli del plugin Pepper Flash possono essere trovati navigando a `chrome://flash` nel browser Chrome. La sua posizione e versione sono utili per il supporto di Flash Pepper in Electron. È anche possibile copiarlo in un'altra posizione.
