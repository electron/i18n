...
L'isolamento del contesto permette a ciascuno degli script in esecuzione nel renderer di apportare modifiche al suo ambiente JavaScript senza preoccuparsi di entrare in conflitto con gli script nell'API Electron o lo script precarico.
