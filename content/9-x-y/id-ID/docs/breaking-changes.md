...
Ini adalah URL yang ditentukan sebagai `disturl` pada file `.npmrc` atau sebagai `--dist-url` bendera perintah saat membangun modul Node asli.  Both will be supported for the foreseeable future but it is recommended that you switch.

Tidak berlaku lagi: https://atom.io/download/electron

Ganti dengan: https://electronjs.org/headers
...
Misalnya Re-enabling the webviewTag
