...
### ` app.showEmojiPanel () </ 0>  <em x-id="4"> macos </ 1>  <em x-id="4"> Windows </ 1></h3>

<p spaces-before="0">Show the platform's native emoji picker.</p>

<h3 spaces-before="0"><code>app.startAccessingSecurityScopedResource(bookmarkData)` _mas_
