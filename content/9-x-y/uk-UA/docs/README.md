...
* [Налаштовування Середовища Розробки](tutorial/development-environment.md)
  * [Налаштовування в macOS](tutorial/development-environment.md#setting-up-macos)
...
* [Архітектура Застосунків](tutorial/application-architecture.md)
  * [Головний та Рендерний процеси](tutorial/application-architecture.md#main-and-renderer-processes)
