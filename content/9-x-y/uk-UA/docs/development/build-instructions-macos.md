...
Офіційні збірки Electron створені за допомогою [Xcode 9.4.1](http://adcdownload.apple.com/Developer_Tools/Xcode_9.4.1/Xcode_9.4.1.xip), та macOS 10.13 SDK.  Building with a newer SDK works too, but the releases currently use the 10.13 SDK.
