...
Electron підтримує [розширення Chrome DevTools][devtools-extension], яке можна використовувати для розширення можливостей для налагодження популярних веб-фреймворків.
...
Використовуючи [React Developer Tools][react-devtools] як приклад:
...
* [Керіброльний зневаджувач](https://cerebraljs.com/docs/introduction/debugger.html)
