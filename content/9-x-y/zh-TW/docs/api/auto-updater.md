...
使用[ electron-winstaller ](https://github.com/electron/windows-installer)或[ electron-forge ](https://github.com/electron-userland/electron-forge)時，請確保不要在第一次執行應用程式[時嘗試對其進行更新](https://github.com/electron/windows-installer#handling-squirrel-events)，（另請參見[此問題以獲取更多訊息](https://github.com/electron/electron/issues/7155)）。 It's also recommended to use [electron-squirrel-startup](https://github.com/mongodb-js/electron-squirrel-startup) to get desktop shortcuts for your app.
