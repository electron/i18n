...
* [Debugging Tools for Windows](https://msdn.microsoft.com/en-us/library/windows/hardware/ff551063.aspx) إذا كنت تخطط لبناء توزيعة كاملة `symstore.exe` يستخدم لإنشاء symbol store من ملفات `.pdb`.
