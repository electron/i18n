...
* Chromium `93`
    * [Nuevo en Chrome 93](https://developer.chrome.com/blog/new-in-chrome-93/)
    * [Nuevo en Chrome 92](https://www.chromestatus.com/features#milestone%3D92)
* Node.js `14.17.0`
...
Vea la [notas de lanzamiento 14.0.0](https://github.com/electron/electron/releases/tag/v14.0.0) para la lista completa de nuevas características y cambios.
...
Electron 11.x.y ha alcanzado el fin de soporte según la [política de soporte ](https://electronjs.org/docs/tutorial/support#supported-versions) del proyecto. Developers and applications are encouraged to upgrade to a newer version of Electron.
