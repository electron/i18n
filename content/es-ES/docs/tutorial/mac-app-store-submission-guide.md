...
Igualmente, dado el uso de las aplicaciones en caja de arena, los recursos que pueden ser accesados por la aplicación son limitados; puede leer [App Sandboxing][app-sandboxing] para más información.
...
Vea la [Documentación sobre la habilitación del acceso de red][network-access] para más detalles.
...
Vea la [documentación sobre la habilitación del acceso del usuario a archivos seleccionados][user-selected] para más información.
...
Dependiendo de los países en los que estás lanzando tu aplicación, puedes ser necesario proporcionar información sobre los algoritmos criptográficos utilizados en tu software. Ver [encryption export compliance docs][export-compliance] para mas información.
