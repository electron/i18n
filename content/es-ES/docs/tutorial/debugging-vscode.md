...
For those unsure where to acquire this code or how to build it, [Electron's Build Tools](https://github.com/electron/build-tools) automates and explains most of this process. Si desea establecer el entorno manualmente, en su lugar puede utilizar estas [build instructions](../development/build-instructions-gn.md).
...
* `your-executable-location` will be one of the following depending on a few items:
  * `Testing`: Si esta utilizando las configuraciones por defecto de [Electron's Build-Tools](https://github.com/electron/build-tools) o las instrucciones por defecto cuando [building from source](../development/build-instructions-gn.md#building).
