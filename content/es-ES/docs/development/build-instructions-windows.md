...
* Herramientas de depuración para Windows de Windows SDK 10.0.15063.468 si planea crear una distribución completa, pues `symstore.exe` is used for creating a symbol store from `.pdb` archivos. 
