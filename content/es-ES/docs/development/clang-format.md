...
Para formatear automáticamente un archivo de acuerdo a estilo de código C++ de Electron, ejecute `clang-format -i path/to/electron/file.cc`. Debería funcionar en macOS/Linux/Windows.
