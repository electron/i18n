...
<script>
  OnLoad = () => {
    ...
    indicador const = Document. querySelector ('. Indicator ')
...
### `<webview>. removeInsertedCSS (llave)`
...
WebView. addEventListener (' New-Window ', Async (e) => {
  const Protocol = (nueva URL (e. URL)). Protocolo
