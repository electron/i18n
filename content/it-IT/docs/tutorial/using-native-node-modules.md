...
[`prebuild`](https://github.com/mafintosh/prebuild) fornisce un modo per pubblicare facilmente i moduli nativi di Node con binari precostruiti per multiple versioni di Node ed Electron.
