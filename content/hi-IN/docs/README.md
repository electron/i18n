...
* [निर्देश (macOS) बिल्ड](development/build-instructions-osx.md)
* [निर्देश (विंडोज) बिल्ड](development/build-instructions-windows.md)
* [निर्देश (लिनक्स) बिल्ड](development/build-instructions-linux.md)
