...
4. [दूरस्थ सामग्री लोड करने वाले सभी सत्रों में `ses.setPermissionRequestHandler()` का उपयोग करें](#handle-session-permission-requests-from-remote-content)
...
11. [WebViews: `allowpopups` न इस्तेमाल करें](#do-not-use-allowpopups)
