...
| `नंबर`                                                                                                         | Simple     | ✅                 | ✅                    | N/A                                                                                                                                                                                                 |
| `बूलियन`                                                                                                       | Simple     | ✅                 | ✅                    | N/A                                                                                                                                                                                                 |
| `ऑब्जेक्ट`                                                                                                     | Complex    | ✅                 | ✅                    | Keys must be supported "Simple" types in this table.  Values must be supported in this table.  Prototype modifications are dropped.  Sending custom classes will copy values but not the prototype. |
