...
Kung ikaw ay nakararanas ng pagbagsak o may nagaganap na di tama sa Electron at alam mo na ito'y di sanhi hindi ng JavaScript application, sa halip ang problema ay nasa mismong Electron, ang pagtatama ng mali (debugging) ay medyo nakakalito lalo na sa mga naglilinang nito na hindi gumagamit ng native/C++ upang mahanap o maitama ang mga mali nito (debugging). Ganoon pa man, gamit ang Visual Studio, GitHub's hosted Electron Symbol Server at ang Electron source code, ay nagpapadali upang maisiguro na masasagawa ng maayos ang mga mali na makikita sa loob ng Electron's source code.

## Mga kinakailangan

* **Ang debug na nabuo ng Electron **: Ang pinakamadaling paraan ay ang magbuo ng mag-isa, sa pamamagitang ng mga gamit at listahan ng pangunahing kailangan sa [pagbuo ng mga pagtuturo sa Windows](build-instructions-windows.md). While you can easily attach to and debug Electron as you can download it directly, you will find that it is heavily optimized, making debugging substantially more difficult: The debugger will not be able to show you the content of all variables and the execution path can seem strange because of inlining, tail calls, and other compiler optimizations.
