...
## Pagdaragdag ng mga Unpacked ng mga File sa `asar` na Archive

Katulad ng nakasaad sa itaas, ilan sa mga Node na API ay ia-unpack ang file sa filesystem kapag nagtatawag, bukod sa mga isyu ng pagganap, ito ay maaari din magbigay daan para sa mga maling alerto ng mga virus scanner.
