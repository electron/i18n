...
- [dialog.showOpenDialog([browserWindow, ]mga opsyon[, callback])](https://github.com/electron/electron/blob/master/docs/api/dialog.md#showOpenDialog)
...
- [mga nilalaman.executeJavaScript(code[, userGesture, mulingtumawag])](https://github.com/electron/electron/blob/master/docs/api/web-contents.md#executeJavaScript)
...
- [mga nilalaman.print([options], [callback])](https://github.com/electron/electron/blob/master/docs/api/web-contents.md#print)
...
- [mga nilalaman.capturePage([rect, ]callback)](https://github.com/electron/electron/blob/master/docs/api/web-contents.md#capturePage)
...
- [cookies.remove(url, pangalan, baliktawag)](https://github.com/electron/electron/blob/master/docs/api/cookies.md#remove)
