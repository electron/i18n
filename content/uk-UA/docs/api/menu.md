...
* `options` Object (опціонально) 
  ...
  * `async` Boolean (optional) - Set to `true` to have this method return immediately called, `false` to return after the menu has been selected or closed. За замовчуванням `false`.
