...
Retourne `String` - Le paramètre de couleur système sous forme hexadécimale RVB (`#ABCDEF`). Voir la [documentation Windows][windows-colors] et la [documentation MacOS][macos-colors] pour plus de détails.
