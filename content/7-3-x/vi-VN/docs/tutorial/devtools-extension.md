...
Electron hỗ trợ [Chrome DevTools Extension][devtools-extension], có thể được sử dụng để nâng khả năng của các công cụ phát triển, giúp debug các framework web thông dụng.
...
Ví dụ như [React Developer Tools][react-devtools]:
