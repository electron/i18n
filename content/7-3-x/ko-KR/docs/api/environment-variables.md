...
Google API 키를 얻으려면, [이 페이지](https://developers.google.com/maps/documentation/javascript/get-api-key)를 방문해 보세요. By default, a newly generated Google API key may not be allowed to make geocoding requests. To enable geocoding requests, visit [this page](https://developers.google.com/maps/documentation/geocoding/get-api-key).
