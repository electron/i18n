...
* 간단한 Electron 앱을 만드는 방법이 궁금하다면, [첫 번째 Electron 앱 만들기][first-app] 문서를 보세요.
* 프로세스 아키텍처가 궁금하신 분은 [메인과 렌더러 프로세스][processes] 문서를 보세요.

Electron에 대해 더 자세히 알고 싶다면 [공식 가이드][readme]문서 목록을 확인하세요.
