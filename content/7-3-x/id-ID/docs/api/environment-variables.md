...
Untuk petunjuk tentang cara mendapatkan kunci Google API , kunjungi

 halaman ini </ 0> . Secara default, kunci Google API yang baru dibuat mungkin tidak diizinkan untuk membuat permintaan geocoding. Untuk mengaktifkan permintaan geocoding, kunjungi  halaman ini </ 0> .</p> 
