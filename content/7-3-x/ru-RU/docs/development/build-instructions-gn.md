...
Для ускорения последующих сборок можно использовать [sccache][sccache]. Add the GN arg `cc_wrapper = "sccache"` by running `gn args out/Debug` to bring up an editor and adding a line to the end of the file.
