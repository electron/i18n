...
Para acelerar las compilaciones posteriores, puedes usar [ sccache ][sccache]. Agregue el argumento `cc_wrapper = "sccache"` ejecutando `gn args out/Debug` para traer un editor y agregar un línea al final del archivo.
