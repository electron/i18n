...
[Aż do wydania Electrona 2.0][arm-breaking-change] Electron będzie również kontynuował wydanie pliku binarnego dla `armv7l` z przyrostek `arm`. Both binaries are identical.
