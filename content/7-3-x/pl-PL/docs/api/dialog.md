...
Argument `browserWindow` pozwala dialogowemu dołączyć się do okna nadrzędnego, czyniąc go modalnym. If the `browserWindow` is not shown, the dialog will not be attached to it. In that case it will be displayed as an independent window.
