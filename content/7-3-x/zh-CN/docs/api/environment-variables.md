...
有关如何获取 Google API key的说明, 请访问 [ 这里 ](https://developers.google.com/maps/documentation/javascript/get-api-key)。 默认情况下, 可能不允许新生成的 Google API key进行地理编码请求。 若要启用地理编码请求, 请访问 [ 这里 ](https://developers.google.com/maps/documentation/geocoding/get-api-key)。
