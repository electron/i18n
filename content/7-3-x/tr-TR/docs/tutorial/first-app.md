...
[`electron/electron-quick-start`][quick-start] deposunu (repository) klonlayın ve bu eğitimdeki kodu kullanarak çalıştırın.
...
Geliştirme sürecinizi başlatmak için kullanıcı belgelerinin ve araçların bir listesi için [BoilerPlates ve CLI belgeleri][boilerplates]ne bakın.
