...
Bu, bir `.npmrc` dosyasında `disturl` olarak veya yerel Node modülleri oluştururken `--dist-url` komut satırı işareti olarak belirtilen URL'dir.  Both will be supported for the foreseeable future but it is recommended that you switch.

Kullanımdan kaldırıldı: https://atom.io/download/electron

Şununla değiştirildi: https://electronjs.org/headers
...
### `yeni Tarayıcı Penceresi ({ webPreferences })`

The following `webPreferences` option default values are deprecated in favor of the new defaults listed below.

| Property           | Deprecated Default                   | New Default |
| ------------------ | ------------------------------------ | ----------- |
| `contextIsolation` | `yanlış`                             | `true`      |
| `nodeIntegration`  | `true`                               | `yanlış`    |
| `webviewTag`       | `nodeIntegration` if set else `true` | `yanlış`    |

Örnek Re-enabling the webviewTag
