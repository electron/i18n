...
После запуска приложения Electron попробуйте перетащить и элемент из BrowserWindow на рабочий стол. В этом руководстве элемент является Markdown файлом, расположенным в корне проекта:
