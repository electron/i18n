...
* Добавление функционала в Ваше приложение 
  ...
  * [Пользовательское меню](tutorial/desktop-environment-integration.md#custom-dock-menu-mac-os)
  * [Пользовательские окна задач](tutorial/windows-taskbar.md)
  ...
  * [Представляет файл для macOS BrowserWindows](tutorial/represented-file.md)
  * [Нативное перемещение файла](tutorial/native-file-drag-drop.md)
* [Доступность приложений](tutorial/accessibility.md) 
