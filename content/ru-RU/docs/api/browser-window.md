...
* `options` Object (необязательно) 
  ...
  * `webPreferences` Object (опционально) - Настройки веб-страниц. 
    ...
    * `nodeIntegrationInWorker` Boolean (опционально) - Будет ли включена интеграция узлов. По умолчанию `true`. Больше об этом можно найти в [Многопоточность](../tutorial/multithreading.md).
