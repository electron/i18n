...
> Контролирует жизненный цикл Вашего приложения.
...
Когда передается `critical`, иконка в dock будет отскакивать, пока приложение не станет активным или запрос не будет отменен.

Когда передается `informational`, иконка в dock будет отскакивать в течение одной секунды. Однако запрос остается до тех пор, пока приложение не станет активным или запрос не будет отменен.
