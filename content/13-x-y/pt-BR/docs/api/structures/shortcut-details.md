...
* `cwd` String (optional) - The working directory. O padrão é vazio.
* `args` String (optional) - The arguments to be applied to `target` when launching from this shortcut. O padrão é vazio.
