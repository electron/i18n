...
> Twórz natywne menu aplikacji oraz kontekstowe menu.
...
* `options` Object (optional)
  ...
  * `positioningItem` Number (optional) _macOS_ - The index of the menu item to be positioned under the mouse cursor at the specified coordinates. Domyślnie to -1.
