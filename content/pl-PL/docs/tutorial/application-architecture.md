...
Zdecydowana większość modułów Node.js *to nie* moduły natywne. Only 400 out of the ~650,000 modules are native. Jednak jeśli potrzebujesz moduły natywne, przejrzyj [ten poradnik jak zrekompilować je dla aplikacji Electron](./using-native-node-modules.md).