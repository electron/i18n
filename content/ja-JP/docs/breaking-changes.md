...
`shell.openItem` API は非同期の `shell.openPath` API に置き換えられました。 元の API の提案と理由は [こちら](https://github.com/electron/governance/blob/main/wg-api/spec-documents/shell-openitem.md) で確認できます。
