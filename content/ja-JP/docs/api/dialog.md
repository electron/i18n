...
* `options` Object
  ...
  * `properties` String[]&#32;(optional) - Contains which features the dialog should use. 以下の値がサポートされています:
...
* `options` Object
  ...
  * `buttons` String[]&#32;(optional) - Array of texts for buttons. Windows では、空の配列は 1 つの "OK" ボタンになります。
