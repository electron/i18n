...
Like Squirrel.Mac, Windows can host updates on S3 or any other static file host. Squirrel.Windows の仕組みの詳細については、[Squirrel.Windows][squirrel-windows] のドキュメントをお読みください。
