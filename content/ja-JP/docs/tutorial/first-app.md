...
Electron は、豊富なネイティブ (オペレーティングシステム) APIを備えたランタイムを提供することで、ピュア JavaScript でデスクトップアプリケーションを開発できるようにします。 Webサーバではなく、デスクトップ・アプリケーションに焦点を当てたNode.jsランタイムがElectronであると捉えても構いません。
