...
バージョン2.0から、Electronは[`semver`に従います](http://semver.org)。 For most applications, and using any recent version of npm, running `$ npm install electron` will do the right thing.
