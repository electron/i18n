...
如果你已經用了一陣子 Node 及 npm，可能早就注意到[語意化版本編號](http://semver.org) (或縮寫 SemVer)。 It's a convention for specifying version numbers for software that helps communicate intentions to the users of your software.
