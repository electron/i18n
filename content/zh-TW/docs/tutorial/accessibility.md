...
Electron 應用程式中的易用性考量與網站類似，畢竟兩者都是 HTML。 With Electron apps, however, you can't use the online resources for accessibility audits because your app doesn't have a URL to point the auditor to.
