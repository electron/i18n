...
These new features bring those auditing tools to your Electron app. Esses novos recursos trazem essas ferramentas de auditoria para seu app Electron. Leia para um resumo das ferramentas ou verifique nossa [documentação de acessibilidade](https://electronjs.org/docs/tutorial/accessibility/) para obter mais informações.
