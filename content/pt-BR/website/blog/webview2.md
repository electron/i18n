...
|                                     |        Electron |                WebView2 |
| ----------------------------------- | ---------------:| -----------------------:|
| Build Dependency                    |        Chromium |                   Borda |
| Source Available on GitHub          |             Sim |                     Não |
| Shares Edge/Chrome DLLs             |             Não |     Yes (as of Edge 90) |
| Shared Runtime Between Applications |             Não |                Opcional |
| Application APIs                    |             Sim |                     Não |
| Node.js                             |             Sim |                     Não |
| Sandbox                             |        Opcional |                  Sempre |
| Requires an Application Framework   |             Não |                     Sim |
| Plataformas Suportadas              | Mac, Win, Linux | Win (Mac/Linux planned) |
