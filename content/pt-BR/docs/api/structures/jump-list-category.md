...
* `tipo` String (opcional) - Um dos seguintes: 
  * `tarefas` - itens nesta categoria serão colocados na categoria de `tarefas` padrão. There can be only one such category, and it will always be displayed at the bottom of the Jump List.
