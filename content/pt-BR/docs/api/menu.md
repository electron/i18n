...
**Obs.:** A instancia `Menu` retornada não suporta adição dinamica ou remoção de itens de menu. [Instance properties](#instance-properties) ainda podem ser modificadas dinamicamente.
