...
## Usando o `electron-installer-snap`

O módulo funciona como o [`electron_winstaller`][electron-winstaller]e módulos semelhantes em que seu escopo é limitado a construir pacotes snap. Você pode testá-lo com:
