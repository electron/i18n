...
* [Utiliser `ses.setPermissionRequestHandler()` dans toutes les sessions qui se chargent de contenu distant](#handle-session-permission-requests-from-remote-content)
...
* [WebViews : Ne pas utiliser `allowpopups`](#do-not-use-allowpopups)
