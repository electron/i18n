...
- [Hazel][hazel] – Update server for private or open-source apps which can be deployed for free on [Vercel][vercel]. Cela récupère les [releases GitHub][gh-releases] et exploite la puissance du CDN de GitHub.
