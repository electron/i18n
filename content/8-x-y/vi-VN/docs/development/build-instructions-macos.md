...
Official Electron builds are built with [Xcode 9.4.1](http://adcdownload.apple.com/Developer_Tools/Xcode_9.4.1/Xcode_9.4.1.xip), and the MacOS 10.13 SDK.  Xây dựng với phiên bản SDK mới hơn cũng hoạt động, nhưng phiên bản phát hành hiện tại đang dùng SDK phiên bản 10.13.
