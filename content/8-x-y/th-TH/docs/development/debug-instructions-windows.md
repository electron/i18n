...
* **Visual Studio ด้วย C ++ เครื่องมือ**: ชุมชนรุ่นฟรีของ Visual สตูดิโอ 2013 และ 2015 Studio แสดงผลทั้งสองงาน เมื่อติดตั้งแล้ว [กําหนดค่า Visual Studio ที่จะใช้ GitHub ของอิเล็กตรอนเซิร์ฟเวอร์สัญลักษณ์](setting-up-symbol-server.md) มันจะเปิดใช้งาน Visual Studio ที่จะได้รับความเข้าใจที่ดีขึ้นของสิ่งที่เกิดขึ้น ภายในอิเล็กตรอนทําให้ง่ายต่อการนําเสนอตัวแปรในมนุษย์อ่าน รูป แบบ
