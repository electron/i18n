...
Google API anahtarını nasıl elde edeceğinizi öğrenmek için [bu](https://developers.google.com/maps/documentation/javascript/get-api-key) sayfayı ziyaret edin. Varsayılan olarak, yeni yaratılmış bir Google API anahtarı geocoding istekleri yapmaya müsait olmayabilir. Geocoding isteklerini açmak içinse [bu](https://developers.google.com/maps/documentation/geocoding/get-api-key) sayfayı ziyaret edebilirsiniz.
