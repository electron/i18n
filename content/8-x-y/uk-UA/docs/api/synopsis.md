...
Основне правило: якщо модуль пов'язаний з [GUI][gui] чи системою на низькому рівні, тоді він має бути доступний в головному процесі. You need to be familiar with the concept of [main process vs. renderer process](../tutorial/application-architecture.md#main-and-renderer-processes) scripts to be able to use those modules.
