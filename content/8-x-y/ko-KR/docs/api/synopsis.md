...
기본 규칙 다음과 같습니다: 모듈이 [GUI][gui]이나 low-level 시스템과 관련되었으면 메인 프로세스에서만 가능합니다. You need to be familiar with the concept of [main process vs. renderer process](../tutorial/application-architecture.md#main-and-renderer-processes) scripts to be able to use those modules.
