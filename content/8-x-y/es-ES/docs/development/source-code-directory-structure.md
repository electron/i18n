...
El repositorio Electronico tiene unas dependencias vendored, encontradas en el directorio[/vendor][vendor]. Ocasionalmente podrás ver un mensaje como este cuando esté ejecutándose `git status`:
