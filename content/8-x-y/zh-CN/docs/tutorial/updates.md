...
如果你的app是通过[`electron-builder`][electron-builder-lib]打包那么你可以使用[electron-updater][]模块, 它不依赖任何服务器并且可以从S3, GitHub或者任何其它静态文件存储更新. 这避开了 Electron 内置的更新机制，这意味着本文档的其余部分不适用于此 ` electron-builder `的更新程序。
