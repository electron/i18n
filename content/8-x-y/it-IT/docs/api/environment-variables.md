...
Per le istruzione su come ottenere una chiave Google API, visita [questa pagina](https://developers.google.com/maps/documentation/javascript/get-api-key). Di default, una nuova chiave Google API è generata ma potrebbe non esserle concesso l'esecuzione di richieste di geocodifica. Per abilitare le richieste di geocodifica, visita [questa pagina](https://developers.google.com/maps/documentation/geocoding/get-api-key).
