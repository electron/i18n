...
<p spaces-before="0"><a href="https://github.com/electron/electron/blob/master/docs/api/breaking-changes.md#duplicate-arm-assets" f-id="arm-breaking-change" lbb="2" fo="1"> Sampai rilis Electron 2.0 </a> , Elektron juga akan lanjutkan untuk melepaskan <code> armv7l </ code> biner dengan akhiran <code> lengan </ code> yang baru. Both binaries
are identical.</p>
