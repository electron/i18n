...
<p spaces-before="0">GPU accelerated rendering berarti GPU digunakan untuk komposisi. Karena itu frame harus disalin dari GPU yang membutuhkan kinerja lebih banyak, sehingga mode ini agak sedikit lebih lambat dari yang lain. Manfaat mode inilah animasi WebGL dan 3D CSS didukung.</p>
...
<p spaces-before="0">Untuk mengaktifkan mode ini akselerasi GPU harus dinonaktifkan dengan memanggil
 API <a href="../api/app.md#appdisablehardwareacceleration" f-id="disablehardwareacceleration" lbb="2" fo="1"><code> app.disableHardwareAcceleration () </ 0>  .</p>
