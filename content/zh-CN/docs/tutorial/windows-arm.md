...
5. You may need to make sure that any symbols for native modules in your app are loaded correctly. 要配置此内容，请进入 Visual Studio 2017_Debug > Options..._，and add the folders containing your `.pdb` symbols under _Debugging > Symbols_.
