...
The [`before-input-event`](../api/web-contents.md#event-before-input-event) event is emitted before dispatching `keydown` and `keyup` events in the page. 它可以用于捕获和处理在菜单中不可见的自定义快捷方式。
