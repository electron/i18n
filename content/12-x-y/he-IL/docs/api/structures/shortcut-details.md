...
* `cwd` String (optional) - The working directory. ריק כברירת מחדל.
* `args` String (optional) - The arguments to be applied to `target` when launching from this shortcut. ריק כברירת מחדל.
