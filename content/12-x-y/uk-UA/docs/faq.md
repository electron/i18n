...
Для досягнення цієї мети, встановіть фон в конструкторі для [BrowserWindow][browser-window]:
...
[підпіксельний приклад]: images/subpixel-rendering-screenshot.gif
