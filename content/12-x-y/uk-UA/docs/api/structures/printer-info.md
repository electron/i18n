...
Число, яке вертає `status`, означає різні речі на різних платформах: у Windows його потенційні значення можна знайти [тут](https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-2), а в Linux та macOS [тут](https://www.cups.org/doc/cupspm.html).
