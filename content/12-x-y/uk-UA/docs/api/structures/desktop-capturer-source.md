...
* `appIcon` [NativeImage](../native-image.md) - Піктограма застосунку, який має вікно або null, якщо джерело має тип екран. Розмір ікони не відомий заздалегідь і залежить від того, що надає додаток.
