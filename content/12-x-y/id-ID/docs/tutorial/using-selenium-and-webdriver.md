...
Dari [ChromeDriver - WebDriver untuk Chrome][chrome-driver]:
...
[Spectron][spectron] adalah kerangka pengujian ChromeDriver yang didukung secara resmi untuk Elektron. Ini dibangun di atas [WebdriverIO](https://webdriver.io/) dan memiliki pembantu untuk mengakses API Elektron dalam pengujian dan kumpulan ChromeDriver Anda.
