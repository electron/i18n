...
Elektron mendukung [Ekstensi DevTools Chrome][devtools-extension], yang dapat digunakan untuk memperluas kemampuan devtools untuk debugging kerangka web populer.
...
Menggunakan [Alat-alat pengembang React][react-devtools] sebagai contoh:
