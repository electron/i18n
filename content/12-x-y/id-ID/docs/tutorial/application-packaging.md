...
Untuk mengurangi [ masalah </ 0> di sekitar nama path yang panjang di Windows , sedikit mempercepat ` require </ 1> dan menyembunyikan kode sumber Anda dari pemeriksaan sepintas, Anda dapat memilih untuk mengemas aplikasi Anda menjadi <a href="https://github.com/electron/asar" f-id="asar" lbb="2" fo="1"> asar </ 2> 
...
by <a href="https://github.com/electron/electron-packager" f-id="electron-packager" fo="2"><code>electron-packager`](https://github.com/joyent/node/issues/6960), [`electron-forge`][electron-forge], and [`electron-builder`][electron-builder]. If you are not using any of these tools, read on.
