...
**Catatan:** Hanya [enumerable properties][enumerable-properties] yang ada Bila objek remote pertama direferensikan bisa diakses via remote.
...
A `NodeJS.Require` function equivalent to `require(module)` in the main process. Modul yang ditentukan oleh jalur relatif mereka akan mengatasi relatif terhadap titik masuk dari proses utama.
