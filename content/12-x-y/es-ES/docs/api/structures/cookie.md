...
* `sameSite` String - La política del [Mismo Sitio](https://developer.mozilla.org/en-US/docs/Web/HTTP/Cookies#SameSite_cookies) se aplica a esta cookie.  Can be `unspecified`, `no_restriction`, `lax` or `strict`.
