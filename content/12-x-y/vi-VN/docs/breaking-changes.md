...
### Các sự kiện không được chấp nhận `hệ thốngPreferences`

Hệ thống `trước các sự kiện` đã không còn được chấp nhận:
* `inverted-color-scheme-changed`
* `high-contrast-color-scheme-changed`

Sử dụng phiên bản `cập nhật` sự kiện trên mô-đun `bản nativeTheme` thay thế.
...
Ví dụ. Re-enabling the webviewTag
