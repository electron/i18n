...
To use this feature on Windows, your application has to be registered as a handler of the file type of the document, otherwise the file won't appear in JumpList even after you have added it. 你可以在[應用程式註冊][app-registration]中找到如何註冊應用程式的資訊。
