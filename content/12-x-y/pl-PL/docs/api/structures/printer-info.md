...
Wartość reprezentowana przez `status` ma inne znaczenia na różnych platformach: w systemie Windows definicje wartości można znaleźć [tutaj](https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-2). Definicje dla systemów Linux i macOS można znaleźć [tutaj](https://www.cups.org/doc/cupspm.html).

## Przykład

Poniżej znajduje się przykład niektórych dodatkowych opcji, które mogą być ustawione, które mogą się różnić na poszczególnych platformach.
