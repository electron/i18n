...
Electron prend en charge [l'extension DevTools de Chrome][devtools-extension], qui peut être utilisé pour étendre les capacités du devtools pour le débogage de framework web populaire.
...
En utilisant [React Developer Tools][react-devtools] comme exemple :
...
1. Passez l'emplacement de l'extension à l'API `BrowserWindow.addDevToolsExtension` pour les outils de développement de React, c'est quelque chose comme :
