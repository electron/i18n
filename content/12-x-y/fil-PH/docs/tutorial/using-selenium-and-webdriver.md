...
Nagmula sa [ChromeDriver - WebDriver para sa Chrome][chrome-driver]:
...
[Spectron][spectron] ay ang opisyal na sinusuportahan ng ChromeDriver sa pagsusuri ng balangkas para sa Electron. Ito ay itinayo sa itaas ng [WebdriverIO](https://webdriver.io/) at may mga katulong upang ma-access ang Electron API sa iyong mga pagsubok at mga bundle na ChromeDriver.
