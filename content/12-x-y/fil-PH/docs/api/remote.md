...
**Note:** Ang [enurable properties][enumerable-properties] lamang na kung saan ay naroroon nang ang remote na bagay ay unang isinangguni na mapupuntahan sa pamamagitan ng remote.
...
A `NodeJS.Require` function equivalent to `require(module)` in the main process. Ang mga modyul na tinukoy nang kanilang kaugnay na landas ay malulutas ng may kaugnayan sa mga pasukan ng mga pangunahing proseso.
