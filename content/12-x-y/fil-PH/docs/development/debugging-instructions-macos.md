...
Ang LLDB ay ang isang makapangyarihang kagamitan na may magandang dokumentasyon. To learn more about it, consider Apple's debugging documentation, for instance the [LLDB Command Structure Reference][lldb-command-structure] or the introduction to [Using LLDB as a Standalone Debugger][lldb-standalone].

Maaari mo ring tingnan ang kamangha-manghang [manwal and tyutoryal][lldb-tutorial] ng LLDB, na mas magpapaliwanag sa mga mas komplikadong sitwasyon ng pagde-debug.
