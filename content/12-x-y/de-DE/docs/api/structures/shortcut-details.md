...
* `cwd` String (optional) - The working directory. Default ist leer.
* `args` String (optional) - The arguments to be applied to `target` when launching from this shortcut. Default ist leer.
