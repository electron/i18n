...
Per raggiungere questo obiettivo, impostare lo sfondo nel costruttore per [BrowserWindow][browser-window]:
...
[esempio di rendering subpixel]: images/subpixel-rendering-screenshot.gif
