...
Per impostare il file rappresentato della finestra, puoi usare le API [FinestraBrowser.impostanomeFileRappresentato][setrepresentedfilename] e [FinestraBrowser.impostaDocumentoPersonalizzato][setdocumentedited].
