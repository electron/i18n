...
Per abilitare questa modalità è necessario disabilitare l'accelerazione GPU chiamando [`app.disableHardwareAcceleration()`][disablehardwareacceleration].
