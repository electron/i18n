...
* `cwd` String (optional) - The working directory. По умолчанию пусто.
* `args` String (optional) - The arguments to be applied to `target` when launching from this shortcut. По умолчанию пусто.
