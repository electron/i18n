...
* `enable_argument_filter` boolean (opsiyonel) - eğer *true* ise herhangi bir PII içermemesi için manuel olarak incelenen belirli bir olaylar listesine göre olay verilerini filtreler. See [the implementation in Chromium][trace_event_args_whitelist.cc] for specifics.
