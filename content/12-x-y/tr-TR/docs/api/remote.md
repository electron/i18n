...
** Not: ** Yalnızca [ numaralandırılabilir özellikler ][enumerable-properties] mevcut Uzak nesneye ilk başvurulduğunda uzaktan erişilebilir.
...
A `NodeJS.Require` function equivalent to `require(module)` in the main process. Göreceli yollarıyla belirtilen modüller ana işlemin giriş noktasına göreli olarak çözümlenir.
