...
[ChromeDriver - Chrome için WebDriver][chrome-driver]'dan:
...
[Spectron][spectron], Electron için resmi olarak desteklenen test çatısıdır. [WebdriverIO](https://webdriver.io/) üzerinde yapılmıştır, testlerinizde Electron API'lerine erişim için yardımcı olur ve içinde ChromeDriver'ı barındırır.
