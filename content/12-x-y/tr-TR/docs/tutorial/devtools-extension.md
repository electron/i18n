...
Electron, popüler web yapılarının hata ayıklamasında Devtool'ların yeteneğini genişletmek için kullanılabilen [Chrome DevTools Extension][devtools-extension] destekler.
...
Örnek olarak [Reaksiyonel geliştirici araçları][react-devtools] kullanılabilir:
