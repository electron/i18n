...
Node.js 모듈의 대부분은 네이티브가 *아닙니다*. Only 400 out of the ~650,000 modules are native. 그러나, 네이티브 모듈을 사용해야하면, [this guide on how to recompile them for Electron](./using-native-node-modules.md)를 참조 하십시오.