...
<p>If the V8 context crashes, the DevTools will display this message.</p>

<p><code>DevTools was disconnected from the page. Once page is reloaded, DevTools will automatically reconnect.`
