...
업그레이드 시 한가지 짚고 넘어가야 할 것은, 호환성 보장을 위해서 Electron의 모든 빌드는 단일 V8 기반으로 이루어져야 한다는 점입니다. This is important because upstream Node and [libchromiumcontent](upgrading-chromium.md) both use their own versions of V8.
