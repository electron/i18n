...
* `id` String - `navigator. web kit Get User Media`를 호출 할 때 `chrome Media Source Id` 제약 조건으로 사용 할 수 있는 윈도우 또는 스크린 식별자입니다. 식별자의 형식은 `윈도우: XX` `스크린:XX`, `XX`는 랜덤 숫자로 생성됩니다.
