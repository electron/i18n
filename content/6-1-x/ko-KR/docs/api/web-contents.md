...
* `options` Object (optional)
  ...
  * `printBackground` Boolean (optional) - Also prints the background color and image of the web page. 기본값은 `false`이다.
...
* `keyCode` String (**required**) - The character that will be sent as the keyboard event. [Accelerator](accelerator.md)의 유효한 키 코드만 사용해야 합니다.
