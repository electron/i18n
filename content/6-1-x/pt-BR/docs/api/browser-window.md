...
* `options` Object (optional)
  ...
  * `kiosk` Boolean (optional) - The kiosk mode. Por padrão é `false`.
  ...
  * `enableLargerThanScreen` Boolean (optional) - Enable the window to be resized larger than screen. Por padrão é `false`.
  ...
  * `transparent` Boolean (optional) - Makes the window [transparent](frameless-window.md). Por padrão é `false`.
