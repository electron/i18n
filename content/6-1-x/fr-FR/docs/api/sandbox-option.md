...
- Un bogue dans le moteur V8 peut permettre au code malveillant d'accéder à la précharge du moteur de rendu APIs, en accordant effectivement un accès complet au système par le module `distant` .
