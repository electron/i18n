...
| **ماي 2014**   | [Atom Shell is open sourced](https://blog.atom.io/2014/05/06/atom-is-now-open-source.html).                    |
| **April 2015** | [Atom Shell is re-named Electron](https://github.com/electron/electron/pull/1389).                             |
| **ماي 2016**   | [إصدارات Electron`v1.0.0`](https://electronjs.org/blog/electron-1-0).                                          |
| **ماي 2016**   | [Electron apps compatible with Mac App Store](mac-app-store-submission-guide.md).                              |
| **أوت 2016**   | [متجر Windows يدعم تطبيقات Electron](windows-store-guide.md).                                                  |
