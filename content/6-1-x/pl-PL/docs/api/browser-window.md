...
* `options` Object (optional)
  ...
  * `enableLargerThanScreen` Boolean (optional) - Enable the window to be resized larger than screen. Domyślnie jest `false`.
  ...
  * `transparent` Boolean (optional) - Makes the window [transparent](frameless-window.md). Domyślnie jest `false`.
