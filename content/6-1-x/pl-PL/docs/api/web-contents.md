...
* `options` Object (optional)
  ...
  * `printBackground` Boolean (optional) - Also prints the background color and image of the web page. Domyślnie jest `false`.
...
* `keyCode` String (**required**) - The character that will be sent as the keyboard event. Powinno używać się tylko prawidłowych kodów klawiszy z [Akceleratora](accelerator.md).
