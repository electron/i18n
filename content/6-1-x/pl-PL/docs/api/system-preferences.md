...
### Zdarzenie: 'accent-color-changed' _Windows_
...
### Zdarzenie: 'color-changed' _Windows_

Zwraca:

* `event` Event

### Zdarzenie: 'inverted-color-scheme-changed' _Windows_
...
### Zdarzenie: 'high-contrast-color-scheme-changed' _Windows_
