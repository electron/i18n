...
Indicates the creation time of the application. Czas jest reprezentowany jako liczba milisekund od epoch. It returns null if it is unable to get the process creation time.
...
Returns an object with V8 heap statistics. Proszę zauważyć, że nie wszystkie statystyki są raportowane w jednostce kilobajtów.
