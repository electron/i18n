...
หากคุณพบปัญหาหรือปัญหาในอิเล็กตรอนที่คุณเชื่อว่าไม่ได้เกิดขึ้น โดยโปรแกรม JavaScript ของคุณ แต่โดยอิเล็กตรอนตัวเอง, การแก้จุดบกพร่องสามารถ จะยุ่งยากเล็กน้อย, โดยเฉพาะอย่างยิ่งสําหรับนักพัฒนาไม่ได้ใช้พื้นเมือง / C ++ ตรวจ แก้ จุด บกพร่อง อย่างไรก็ตาม โดยใช้ Visual Studio, GitHub ของโฮสต์เซิร์ฟเวอร์สัญลักษณ์อิเล็กตรอน, และรหัสแหล่งที่มาอิเล็กตรอนคุณสามารถเปิดใช้งานการแก้จุดบกพร่องขั้นตอนผ่าน กับจุดพักภายในรหัสแหล่งที่มาของอิเล็กตรอน
...
* **Visual Studio with C++ Tools**: The free community editions of Visual Studio 2013 and Visual Studio 2015 both work. เมื่อติดตั้งแล้ว [กําหนดค่า Visual Studio ที่จะใช้ GitHub ของอิเล็กตรอนเซิร์ฟเวอร์สัญลักษณ์](setting-up-symbol-server.md) มันจะเปิดใช้งาน Visual Studio ที่จะได้รับความเข้าใจที่ดีขึ้นของสิ่งที่เกิดขึ้น ภายในอิเล็กตรอนทําให้ง่ายต่อการนําเสนอตัวแปรในมนุษย์อ่าน รูป แบบ
