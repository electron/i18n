...
* `options` Object (optional)
  ...
  * `enableLargerThanScreen` Boolean (optional) - Enable the window to be resized larger than screen. Modul implicit este `false-fals`.
  ...
  * `transparent` Boolean (optional) - Makes the window [transparent](frameless-window.md). Modul implicit este `false-fals`.
