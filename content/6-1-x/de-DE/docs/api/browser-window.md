...
* `options` Object (optional)
  ...
  * `enableLargerThanScreen` Boolean (optional) - Enable the window to be resized larger than screen. Standard ist `false`.
  ...
  * `hasShadow` Boolean (optional) - Whether window should have a shadow. This is only implemented on macOS. Standard ist `true`.
  ...
  * `transparent` Boolean (optional) - Makes the window [transparent](frameless-window.md). Standard ist `false`.
