...
* `ดำเนินการ` String - Specifies the action to take place when ending [`webContents.findInPage`] request. 
...
* `options` Object (optional) สิทธิพิเศษ 
  ...
  * `margins` Object (optional) สิทธิพิเศษ 
  ...
  * `dpi` Object (optional) สิทธิพิเศษ 
