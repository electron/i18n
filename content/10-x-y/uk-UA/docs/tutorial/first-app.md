...
Що стосується розробки застосунків Electron це по суті Node.js app. The starting point is a `package.json` that is identical to that of a Node.js module. Базовий Electron застосунок міг би мати таку структуру теки:
...
function createWindow () {
  ...
  // і завантажте index.html додатку.
...
$ git clone https://github. om/electron/electron-quick-start
