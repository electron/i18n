...
* `error` Integer (optional) - When assigned, the `request` will fail with the `error` number . Mevcut hata numaraları için lütfen bakın [net hataların listesi][net-error].
