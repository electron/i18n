...
* [İlk Uygulamanızı Oluşturma](tutorial/first-app.md)
  * [Electron'u Yükleyin](tutorial/first-app.md#installing-electron)
  * [Kısaca Elektron Geliştirme](tutorial/first-app.md#electron-development-in-a-nutshell)
  * [Uygulamanızı Çalıştırın](tutorial/first-app.md#running-your-app)
