...
Mendaftarkan skema sebagai standar akan memungkinkan akses ke file melalui [FileSystem API][file-system-api]. Jika tidak, renderer akan membuang kesalahan keamanan untuk skema ini.
