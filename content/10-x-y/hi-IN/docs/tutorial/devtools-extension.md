...
इलेक्ट्रॉन [क्रोम डेवटूल्स एक्सटेंशन][devtools-extension] समर्थन करता है, यह लोकप्रिय वेब रूपरेखा डिबगिंग के लिए डेवटूल्स की क्षमता का विस्तार करने के लिए उपयोग किया जाता है।
...
उदाहरण के रूप में [रिएक्टर डेवलपर उपकरण ][react-devtools] का उपयोग करना:
