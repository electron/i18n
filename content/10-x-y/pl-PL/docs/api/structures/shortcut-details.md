...
* `cwd` String (optional) - The working directory. Domyślnie jest pusty.
* `args` String (optional) - The arguments to be applied to `target` when launching from this shortcut. Domyślnie jest pusty.
