...
Zespół Electron utrzymuje [update.electronjs.org][], darmową i otwarto-źródłową usługę, której aplikacje Electron mogą używać do samodzielnej aktualizacji. The service is designed for Electron apps that meet the following criteria:
