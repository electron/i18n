...
La maggior parte degli utenti potrà usufruire gratuitamente di questa funzionalità, in quanto pienamente supportata da [`electron-packager`][electron-packager], [`electron-forge`][electron-forge], e [`electron-builder`][electron-builder]. If you are not using any of these tools, read on.
