...
<li>Make sure the native module is compatible with the target platform and
architecture for your Electron app.</li>
<li>Make sure <code>win_delay_load_hook` is not set to `false` in the module's `binding.gyp`.
