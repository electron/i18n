...
- [dialog.showOpenDialog([browserWindow, ]seçenekleri[, callback])](https://github.com/electron/electron/blob/master/docs/api/dialog.md#showOpenDialog)
- [dialog.showSaveDialog([browserWindow, ]seçenekleri[, callback])](https://github.com/electron/electron/blob/master/docs/api/dialog.md#showSaveDialog)
- [diyalog.gösterilecekMesajKutusu([browserWindow, ]seçenekler[, geri arama])](https://github.com/electron/electron/blob/master/docs/api/dialog.md#showMessageBox)
