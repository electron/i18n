...
* Unter Windows-Betriebssystemen funktionieren transparente Fenster nicht, wenn DWM deaktiviert ist.
* Unter Linux müssen Benutzer `--enable-transparent-visuals --disable-gpu` in der Befehlszeile setzen, um GPU zu deaktivieren und ARGB erlauben, transparentes Fenster zu machen, dies durch einen Upstream-Fehler verursacht wird, dass [Alphakanal auf einigen NVidia-Treibern, die auf Linux](https://bugs.chromium.org/p/chromium/issues/detail?id=369209) , nicht funktioniert.
* Auf dem Mac wird der systemeigene Fensterschatten nicht in einem transparenten Fenster angezeigt.
