...
Um Ihre Anwendung ohne Neuaufbau von Electron zu testen, [platzieren](application-distribution.md) Sie Ihre App-Quelle in das Ressourcenverzeichnis von Electron.
