...
const driver = new webdriver.Builder()
  ...
  .withCapabilities('
    'goog:chromeOptions': '
      * Hier ist der Pfad zu Ihrer Electron-Binärdatei.
      binär: '/Path-to-Your-App.app/Contents/MacOS/Electron'
    '
  '
  .forBrowser('chrome') / Hinweis: verwenden Sie .forBrowser('electron') für selenium-webdriver <= 3.6.0
  .build()
...
driver.wait()=>
  return driver.getTitle().then(title) => -
    Rückgabetitel === 'webdriver - Google Search'
  ')
, 1000)
