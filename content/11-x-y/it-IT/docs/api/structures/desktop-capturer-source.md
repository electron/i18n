...
* `appIcon` [NativeImage](../native-image.md) - Un'icona dell'applicazione che possiede la finestra o null se la sorgente ha un tipo schermo. The size of the icon is not known in advance and depends on what the application provides.
