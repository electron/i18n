...
`ClientRequest` implementa l'interfaccia [Writable Stream](https://nodejs.org/api/stream.html#stream_writable_streams) ed è dunque un [EventEmitter][event-emitter].
