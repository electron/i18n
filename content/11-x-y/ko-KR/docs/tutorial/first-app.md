...
[`electron/electron-quick-start`][quick-start] 저장소를 clone하여 이 문서에서 설명한 코드를 실행해 볼 수 있습니다.
...
개발 편의성을 제공하는 boilerplates와 도구 목록을 확인하려면, [Boilerplates와 CLI][boilerplates] 문서를 참고하세요.
