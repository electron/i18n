...
### Recente documenten toevoegen aan het programmamenu:

![macOS Recente Documenten menu-item][6]

U kunt menu-items toevoegen om recente documenten te openen en te wissen door de volgende code snippet toe te voegen aan de template van uw menu.
