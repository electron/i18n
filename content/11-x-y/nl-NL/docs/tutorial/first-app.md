...
Standaard zou `npm start` het hoofdscript met Node.js uitvoeren. Om met Electron te laten draaien, kun je een `start` script toevoegen:
...
// Afsluiten wanneer alle vensters gesloten zijn, behalve op macOS. Daar is het gebruikelijk
// voor toepassingen en hun menubalk om actief te blijven totdat de gebruiker
// expliciet stopt met Cmd + Q.
...
app. n('activeren', () => {
  // Op macOS is het gebruikelijk om opnieuw een venster in de app te maken wanneer het
