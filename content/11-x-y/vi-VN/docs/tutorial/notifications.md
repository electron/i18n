...
* On Windows 8.1 and Windows 8, a shortcut to your app with an [Application User Model ID][app-user-model-id] must be installed to the Start screen. Lưu ý, Tuy nhiên, nó không cần phải được ghim vào màn hình Start.
