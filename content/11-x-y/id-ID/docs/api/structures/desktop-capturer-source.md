...
* `appIcon` [NativeImage](../native-image.md) -sebuah gambar ikon dari aplikasi yang memiliki window atau null jika sumber memiliki sejenis layar. The size of the icon is not known in advance and depends on what the application provides.
