...
За замовчуванням `npm start` буде запускати основний скрипт з Node.js. щоб змусити запустити його з Electron, ви можете додати `старт`:
...
// Вийти з закритих всіх вікон, крім macOS. Там є поширений
// для додатків та їх рядка меню, щоб бути активним поки користувач не завершився
// явно з Cmd + Q.
app.on('window-all-closed', () => {
  якщо (process.platform !== 'darwin') {
    . uit()
  }
}) програма

. n('активація', () => {
  // На macOS звично повторно створити вікно у застосунку, коли в панелі
  // клацнули значок, і інші вікна не відкриваються.
