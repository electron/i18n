...
* `appIcon` [NativeImage](../native-image.md) - 可能是带有 window 的应用的图标， 或者 srouce 有一个 type screen 时null。 The size of the icon is not known in advance and depends on what the application provides.
