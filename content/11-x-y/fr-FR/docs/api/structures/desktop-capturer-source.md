...
* `appIcon` [NativeImage](../native-image.md) - Un icône de l'application qui possède la fenêtre ou qui est nul si la source a un écran type. The size of the icon is not known in advance and depends on what the application provides.
