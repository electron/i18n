...
* Visual Studio 2017 15.7.2 of hoger - [download VS 2017 Community Edition gratis](https://www.visualstudio.com/vs/)
* [Python 2.7.10 of hoger](http://www.python.org/download/releases/2.7/) 
...
* Debugging Tools for Windows of Windows SDK 10.0.15063.468 if you plan on creating a full distribution since `symstore.exe` is used for creating a symbol store from `.pdb` bestanden. 
  * Verschillende versies van de SDK kunnen naast elkaar worden geïnstalleerd. To install the SDK, open Visual Studio Installer, select `Change` → `Individual Components`, scroll down and select the appropriate Windows SDK to install. Another option would be to look at the [Windows SDK and emulator archive](https://developer.microsoft.com/en-us/windows/downloads/sdk-archive) and download the standalone version of the SDK respectively.
