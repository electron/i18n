...
| **Květen 2014** | [Atom Shell is open sourced](https://blog.atom.io/2014/05/06/atom-is-now-open-source.html).                    |
...
| **Květen 2016** | [Electron apps compatible with Mac App Store](mac-app-store-submission-guide.md).                              |
| **Srpen 2016**  | [Windows Store support for Electron apps](windows-store-guide.md).                                             |